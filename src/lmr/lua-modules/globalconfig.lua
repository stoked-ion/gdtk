...
-- History:
--    2024-02-11 -- moved from eilmer4/configoptions.lua
--                  motivation is to re-work options for lmr5
--
...
configOptionsHidden = { -- hidden from user
   ...
   include_boundary_faces_in_spatial_deriv_correction = false,
...
globalconfig.config = {}
setmetatable(globalconfig.config, configOptionsHidden)
