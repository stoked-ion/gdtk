...
function output.write_config_file(fileName)
   ...
   f:write(string.format('"dualtimestepping_update_scheme": "%s",\n', config.dualtimestepping_update_scheme))
   ...
   f:write(string.format('"electric_field_start_time": %.18e,\n', config.electric_field_start_time))
   f:write(string.format('"applied_Bz": %.18e,\n', config.applied_Bz))
   f:write(string.format('"applied_B_ramp": %.18e,\n', config.applied_B_ramp))
   f:write(string.format('"applied_B_x0": %.18e,\n', config.applied_B_x0))
   f:write(string.format('"applied_B_x1": %.18e,\n', config.applied_B_x1))
   f:write(string.format('"applied_B_table": "%s",\n', config.applied_B_table))
   f:write(string.format('"mhd_source": %s,\n', tostring(config.mhd_source)))
   f:write(string.format('"mhd_source_xmin": %.18e,\n', config.mhd_source_xmin))
   f:write(string.format('"mhd_source_xmax": %.18e,\n', config.mhd_source_xmax))
   f:write(string.format('"mhd_source_ymin": %.18e,\n', config.mhd_source_ymin))
   f:write(string.format('"mhd_source_ymax": %.18e,\n', config.mhd_source_ymax))
   f:write(string.format('"mhd_source_yguard_xmax": %.18e,\n', config.mhd_source_yguard_xmax))
   f:write(string.format('"mhd_source_ramp_start": %d,\n', config.mhd_source_ramp_start))
   f:write(string.format('"mhd_source_ramp_steps": %d,\n', config.mhd_source_ramp_steps))
   f:write(string.format('"mhd_source_differentiate_sigma": %s,\n', tostring(config.mhd_source_differentiate_sigma)))
   f:write(string.format('"solve_electric_field": %s,\n', tostring(config.solve_electric_field)))
   f:write(string.format('"electric_field_gmres_iters": %d,\n', config.electric_field_gmres_iters))
   f:write(string.format('"electric_field_freeze_in_linear_solve": %s,\n', tostring(config.electric_field_freeze_in_linear_solve)))
   ...
   f:write(string.format('"clip_small_gas_composition_values": %s,\n', tostring(config.clip_small_gas_composition_values)))
   f:write(string.format('"unstructured_limiter": "%s",\n', config.unstructured_limiter))
   f:write(string.format('"apply_unstructured_limiter_stagnation_point_filter": %s,\n', tostring(config.apply_unstructured_limiter_stagnation_point_filter)))
   f:write(string.format('"apply_unstructured_limiter_min_pressure_filter": %s,\n', tostring(config.apply_unstructured_limiter_min_pressure_filter)))
   ...
   f:write(string.format('"shock_detector_minimum_blend_value": %.18e,\n', config.shock_detector_minimum_blend_value))
